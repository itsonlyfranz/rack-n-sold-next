...
export function NFTMarketplaceHero() {
  ...
  return (
    <div className="w-full bg-gray-950">
        ...
        <div className="container mx-auto px-4 relative z-10">
          <div className="flex flex-col items-center text-center max-w-4xl mx-auto">
            ...
            <div className="animate-appear opacity-0 flex flex-col sm:flex-row gap-4 mb-16" style={{ animationDelay: "300ms" }}>
              ...
              <Button size="lg" variant="outline" className="border-emerald-700/60 bg-emerald-950/20 text-emerald-100 hover:border-emerald-400/70 hover:bg-emerald-900/40 hover:text-white px-8 relative overflow-hidden group">
                <Link href="/auth/signup" className="flex items-center gap-2 relative z-10">
                  <Sparkles className="h-4 w-4" />
                  New to NFTs? Start Here
                </Link>
                <div className="absolute inset-0 bg-gradient-to-r from-emerald-500/15 to-teal-500/15 opacity-0 group-hover:opacity-100 transition-opacity duration-300 -z-10"></div>
              </Button>
            </div>
      ...
      <section className="py-24 px-4">
        <div className="container mx-auto">
          <div className="relative overflow-hidden rounded-3xl border border-emerald-700/40 bg-gradient-to-r from-gray-950 via-emerald-950 to-teal-950 p-8 shadow-2xl shadow-emerald-950/30 md:p-16 animate-scale">
            {/* Background elements */}
            <div className="absolute inset-0 overflow-hidden">
            ...
            <div className="relative z-10 flex flex-col md:flex-row items-center justify-between gap-8">
              <div className="text-center md:text-left">
                ...
                <p className="text-emerald-100/85 max-w-xl">
              ...
              <div className="flex flex-col sm:flex-row gap-4">
                <Button size="lg" className="bg-gradient-to-r from-emerald-500 to-teal-500 text-white hover:from-emerald-400 hover:to-teal-400 border-0 px-8 relative overflow-hidden group shadow-lg shadow-emerald-950/40">
                  <Link href="/auth/signup" className="flex items-center gap-2 relative z-10">
                    Start Your Journey
                  </Link>
                  <div className="absolute inset-0 bg-gradient-to-r from-emerald-400 to-teal-400 opacity-0 group-hover:opacity-100 transition-opacity duration-300 -z-10"></div>
                </Button>
                <Button size="lg" variant="outline" className="border-emerald-400/60 bg-emerald-950/20 text-emerald-100 hover:border-emerald-300 hover:bg-emerald-900/40 hover:text-white px-8 relative overflow-hidden group">
            ...
            <div className="mt-12 pt-8 border-t border-white/20 flex flex-col md:flex-row items-center justify-between gap-6">
              <div className="flex items-center gap-4">
                <div className="w-12 h-12 rounded-full bg-emerald-400/10 backdrop-blur-sm flex items-center justify-center">
                ...
                <div>
                  ...
                  <p className="text-emerald-100/80 text-sm">Access the world's largest NFT marketplace</p>
                </div>
              </div>
